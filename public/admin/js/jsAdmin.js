...
$("#btn_add").click(function (e) {
  ...
  $.ajax({
    ...
    success: function (result) {
      alert("Admin/Vendor Added Succesfully");
      location.reload();
  ...
  $(document).on("click", "#btn_update", function () {
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        alert("Admin/Vendor Details Updated Succesfully");
        location.reload();
      },
      error: function (request, error) {
        console.error(error);
